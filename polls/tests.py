...
class QuestionModelTests(TestCase):
    def test_was_published_recently_future_question(self):
        """
        was_published_recently should return False for future posts. 
        """
    ...
    def test_was_published_recently_recent_question(self):
        """
        this function return True if the question is not older or equal than 1 day
        """
...
def create_question(question_text, days):
    """
    Create a question with the given time 'question_text' and published the given 
